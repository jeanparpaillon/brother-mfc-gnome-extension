...
- `docs/design.md` — architecture, and the environment facts it rests on. Numbered
  sections (§1, §2.1, …) so issues can cite them. Decisions go here; tasks do not.
...
Development and testing happen on the machine described in `~/CLAUDE.md`. Two
constraints from there bear directly on this project:
